...
boringWords = ["THE","THEY","THEY'RE","YOU","YOU'RE","YOU'VE","YOU,","SO","HAVE","-","AN","JUST","I","WE","A","DOESN'T","DOES","IS","ISN'T","TO","SHOULD","AND","OR","BUT","HE","SHE","DON'T","DO","ME","ABOUT","SAY","ONLY","ALL","THIS","THAT","WE'VE","WE'RE","IS","I","MAKES","HAS","HAD","HAVE","HAVING","HASN'T","LET'S","HERE,","OF","WOULD","AS","WAS","HE'LL"]

findingTitle = 1
for i in range(1, numChampters):
  findingTitle = 1
  while(findingTitle == 1):
    thing = text_model.make_sentence()
    if(thing != None):
      word1 = random.choice(thing.split())
    else:
      word1 = "the"
    if(word1.upper() not in boringWords):
      findingTitle = 0;
...
<html>
  ...
  <style>
    ...
    html{{
      margin: 0cm;
      background-image: url("https://emmarhoades.com/images/free-christmas-clipart-borders-2.png");
